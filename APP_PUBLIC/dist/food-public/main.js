...
var FoodDataService = /** @class */ (function () {
    function FoodDataService(http) {
        this.http = http;
        this.foodsUrl = 'http://localhost:3000/api/foods';
    }
    // get("/api/foods")
...
module.exports = "<div *ngFor=\"let food of foods\">{{food.name}}</div>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _food_data_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../food-data.service */ "./src/app/food-data.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeListComponent = /** @class */ (function () {
    ...
    HomeListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_food_data_service__WEBPACK_IMPORTED_MODULE_1__["FoodDataService"]]
        }),
        __metadata("design:paramtypes", [_food_data_service__WEBPACK_IMPORTED_MODULE_1__["FoodDataService"]])
    ], HomeListComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Plum\test\task10\task10\APP_PUBLIC\src\main.ts */"./src/main.ts");
